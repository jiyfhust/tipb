...
type Limit struct {
	...
	CoveredCount     uint64        `protobuf:"varint,7,opt,name=CoveredCount" json:"CoveredCount"`
	XXX_unrecognized []byte        `json:"-"`
}
...
func (m *Limit) GetCoveredCount() uint64 {
	if m != nil {
		return m.CoveredCount
	}
	return 0
}
...
func (m *Limit) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x38
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(m.CoveredCount))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *Limit) Size() (n int) {
	...
	n += 2
	n += 1 + sovExecutor(uint64(m.CoveredCount))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
...
func (m *Limit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoveredCount", wireType)
			}
			m.CoveredCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoveredCount |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorExecutor = []byte{
	...
	,
}
