...
type Limit struct {
	...
	// add by jiyf
	Conditions                 []*Expr       `protobuf:"bytes,3,rep,name=conditions" json:"conditions,omitempty"`
	RpnConditions              []*RpnExpr    `protobuf:"bytes,4,rep,name=rpn_conditions,json=rpnConditions" json:"rpn_conditions,omitempty"`
	Columns                    []*ColumnInfo `protobuf:"bytes,5,rep,name=columns" json:"columns,omitempty"`
	TableCondCoveredByPreIndex *bool         `protobuf:"varint,6,opt,name=tableCondCoveredByPreIndex" json:"tableCondCoveredByPreIndex,omitempty"`
	PrefIndexOffset            *uint64       `protobuf:"varint,7,opt,name=prefIndexOffset" json:"prefIndexOffset,omitempty"`
	XXX_unrecognized           []byte        `json:"-"`
}
...
func (m *Limit) GetConditions() []*Expr {
	if m != nil {
		return m.Conditions
	}
	return nil
...
func (m *Limit) GetRpnConditions() []*RpnExpr {
	if m != nil {
		return m.RpnConditions
	}
	return nil
...
func (m *Limit) GetColumns() []*ColumnInfo {
	if m != nil {
		return m.Columns
	}
	return nil
...
func (m *Limit) GetTableCondCoveredByPreIndex() bool {
	if m != nil && m.TableCondCoveredByPreIndex != nil {
		return *m.TableCondCoveredByPreIndex
	}
	return false
}

func (m *Limit) GetPrefIndexOffset() uint64 {
	if m != nil && m.PrefIndexOffset != nil {
		return *m.PrefIndexOffset
	}
	return 0
}
...
func (m *Limit) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TableCondCoveredByPreIndex != nil {
		dAtA[i] = 0x30
		i++
		if *m.TableCondCoveredByPreIndex {
			dAtA[i] = 1
		} else {
			dAtA[i] = 0
		}
	...
	if m.PrefIndexOffset != nil {
		dAtA[i] = 0x38
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.PrefIndexOffset))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Limit) Size() (n int) {
	...
	if m.PrefIndexOffset != nil {
		n += 1 + sovExecutor(uint64(*m.PrefIndexOffset))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Limit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableCondCoveredByPreIndex", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.TableCondCoveredByPreIndex = &b
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrefIndexOffset", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
