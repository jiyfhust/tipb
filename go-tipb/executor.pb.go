...
type Limit struct {
	...
	TableCondCoveredByPreIndex bool          `protobuf:"varint,6,opt,name=tableCondCoveredByPreIndex" json:"tableCondCoveredByPreIndex"`
	PrefIndexOffset            uint64        `protobuf:"varint,7,opt,name=prefIndexOffset" json:"prefIndexOffset"`
	XXX_unrecognized           []byte        `json:"-"`
}
...
func (m *Limit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.TableCondCoveredByPreIndex = bool(v != 0)
		case 7:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrefIndexOffset |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorExecutor = []byte{
	...
	,
}
