...
type Limit struct {
	...
	CoveredPreIndex   bool          `protobuf:"varint,6,opt,name=CoveredPreIndex" json:"CoveredPreIndex"`
	CoveredIndexCount int32         `protobuf:"varint,7,opt,name=CoveredIndexCount" json:"CoveredIndexCount"`
	XXX_unrecognized  []byte        `json:"-"`
}
...
func (m *Limit) GetCoveredPreIndex() bool {
	if m != nil {
		return m.CoveredPreIndex
	}
	return false
}

func (m *Limit) GetCoveredIndexCount() int32 {
	if m != nil {
		return m.CoveredIndexCount
	}
	return 0
}
...
func (m *Limit) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x38
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(m.CoveredIndexCount))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *Limit) Size() (n int) {
	...
	n += 2
	n += 1 + sovExecutor(uint64(m.CoveredIndexCount))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
...
func (m *Limit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoveredPreIndex", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CoveredPreIndex = bool(v != 0)
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoveredIndexCount", wireType)
			}
			m.CoveredIndexCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExecutor
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoveredIndexCount |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorExecutor = []byte{
	...
	,
}
